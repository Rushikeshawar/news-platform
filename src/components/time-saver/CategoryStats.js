  ...
  const statsCards = [
    {
      id: 'todayNewCount',
      title: "Today's New",
      value: stats.todayNewCount || 0,
      icon: Calendar,
      color: 'blue',
      description: 'Fresh content today'
    },
    {
      id: 'criticalCount',
    ...
    },
    {
      id: 'viralBuzzCount',
      title: 'Viral & Buzz',
      value: stats.viralBuzzCount || 0,
      icon: BarChart3,
      color: 'purple',
      description: 'Trending content'
    },
    {
      id: 'changingNormsCount',
      title: 'Changing Norms',
      value: stats.changingNormsCount || 0,
      icon: Users,
      color: 'orange',
      description: 'Social & cultural shifts'
    },
    {
      id: 'monthlyCount',
      title: 'Monthly Top',
